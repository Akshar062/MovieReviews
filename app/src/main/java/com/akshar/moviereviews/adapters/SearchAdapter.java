...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchViewHolder> {
    ...
    public SearchAdapter(Context context, List<AllModel.Result> resultList) {
        ...
        switch (result.getMediaType()) {
            case "movie":
                ...
                if (result.getPosterPath() != null) {
                    ...
                    setImage(holder,result.getBackdropPath());
                }
                break;
            case "tv":
            ...
            case "person":
                ...
                if (result.getProfilePath() != null){
                    ...
                    if (knownForList.get(0).getPosterPath() != null){
                        setImage(holder, knownForList.get(0).getPosterPath());
                    } else {
                        setImage(holder,knownForList.get(0).getBackdropPath());
                    }
                }
                break;
        }
    ...
    private void setImage(SearchViewHolder holder ,String path) {
        Picasso.get()
